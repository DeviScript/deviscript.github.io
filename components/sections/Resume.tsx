...
const Resume = () => {
  ...
  const handlePrint = useReactToPrint({
    contentRef: printRef,
    documentTitle: "Brian_Lockhart_Resume",
    pageStyle: `
      @page {
        size: A4;
        margin: 15mm;
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <button onClick={handlePrint} className="btn-primary group">
              Download PDF Resume
              <Download
                size={18}
        ...
        <div ref={printRef} className="hidden print:block">
          <div style={{ padding: "0", margin: "0" }}>
            {/* Header */}
            <h1 style={{ marginBottom: "4px" }}>Brian Lockhart</h1>
            ...
            <div className="contact-info" style={{ marginBottom: "12px" }}>
              <span>1319 Langdon Pl · Pittsboro, NC 27312</span>
              <span>•</span>
              <span>(919) 444-0167</span>
              <span>•</span>
              <span>deviscript@gmail.com</span>
              <span>•</span>
              <span>outerwavelogistics.com · outerwaveapp.com</span>
            </div>
            ...
            <div className="section">
              ...
              <p>
                Strategic, systems-minded professional with a rare blend of
                Interdisciplinary Studies, Accounting discipline, and hands-on
                programming capability. Dual 4.0 GPA and Phi Kappa Phi honoree.
                Adept at moving from data structures and SQL pipelines to market
                research and go-to-market strategy. Known for turning ambiguity
                into structure, building clean workflows in
                Excel/SQL/JavaScript, and delivering analysis that drives
                decisions.
              </p>
            </div>
            ...
            <div className="section">
              ...
              <ul>
                <li>
                  <strong>Rigorous Thinker:</strong> Dual 4.0 GPAs (B.A.
                  Interdisciplinary Studies; B.S. Accounting coursework)
                  demonstrate analytical discipline and logical structure.
                </li>
                <li>
                  <strong>Code-Capable Operator:</strong> Full-stack trained
                  (UNC Chapel Hill Bootcamp) with proficiency in JavaScript,
                  Node.js, Express, SQL/NoSQL, React, and related tools.
                </li>
                <li>
                  <strong>Market-Literate:</strong> Conducted market research
                  and delivered strategic insights as part of a global business
                  collaboration through X-Culture.
                </li>
                <li>
                  <strong>Global Collaborator:</strong> Selected for the
                  X-Culture Global Symposium, delivering a real-world strategy
                  for a Polish engineering client.
                </li>
                <li>
                  <strong>Founder's Mindset:</strong> Building and operating
                  Outerwave Logistics and Outerwave App — combining business
                  acumen with technical implementation.
                </li>
              </ul>
            </div>
            ...
            <div className="section">
              ...
              <div className="experience-item">
                <h3>Business Owner (Current) · Outerwave Logistics</h3>
                <p
                  style={{
                    fontSize: "9pt",
                    fontStyle: "italic",
                ...
                <ul>
                  <li>
                    Build and manage a logistics venture focused on operational
                    clarity, cost structure, and reliable customer service.
                  </li>
                  <li>
                    Use Excel and SQL to maintain clean datasets for quoting,
                    margin tracking, and operational reporting.
                  </li>
                  <li>
                    Apply accounting methods to pricing, reconciliation, and
                    financial planning.
                  </li>
                </ul>
              </div>
              ...
              <div className="experience-item">
                <h3>Business Owner (Current) · Outerwave App</h3>
                <p
                  style={{
                    fontSize: "9pt",
                    fontStyle: "italic",
                ...
                <ul>
                  <li>
                    Develop and iterate on a logistics-focused application
                    informed by real-world operational constraints.
                  </li>
                  <li>
                    Leverage full-stack skills to prototype features, manage
                    Git-based development workflows, and integrate RESTful Web
                    APIs.
                  </li>
                  <li>
            ...
            <div className="section">
              ...
              <div className="experience-item">
                <h3>X-Culture Global Symposium — July 2023</h3>
                <p style={{ fontStyle: "italic", marginBottom: "4px" }}>
                  Participant & Team Collaborator
                </p>
                <ul>
                  <li>
                    Selected as one of 150 global students for a cross-cultural
                    business strategy initiative.
                  </li>
                  <li>
                    Delivered a strategic proposal for Avros Engineering
                    (Poland), addressing international expansion and product
                    positioning.
                  </li>
                  <li>
                    Practiced research synthesis, structured problem-solving,
                    and team-based execution under tight deadlines.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="section">
              ...
              <div className="education-item">
                ...
                <p style={{ marginBottom: "2px" }}>
                  <strong>B.A., Interdisciplinary Studies</strong> · Sep 2020 –
                  Dec 2023
                </p>
                <p>
                  <span className="badge">GPA: 4.0</span>
                  <span className="badge">Phi Kappa Phi Honor Society</span>
                </p>
              </div>

              <div className="education-item">
                <h3>Bryan School of Business & Economics (UNCG)</h3>
                <p style={{ marginBottom: "2px" }}>
                  <strong>B.S., Accounting (coursework)</strong> · Sep 2019 –
                  Sep 2020
                </p>
                <p>
                  <span className="badge">GPA: 4.0</span>
              ...
              <div className="education-item">
                <h3>Florida State College</h3>
                <p style={{ marginBottom: "2px" }}>
                  <strong>Pre-Major, Business Administration</strong> · Aug 2011
                  – Dec 2013
                </p>
                <p>
                  <span className="badge">GPA: 3.95</span>
                </p>
              </div>
            </div>
            ...
            <div className="section">
              ...
              <ul>
                <li>
                  <strong>Languages/Runtime:</strong> JavaScript (ES6+), HTML,
                  CSS, Node.js
                </li>
                <li>
                  <strong>Frameworks/Libraries:</strong> Express.js, React, MERN
                  stack (foundational), PWAs
                </li>
                <li>
                  <strong>Data & Analysis:</strong> SQL, NoSQL basics, ORM,
                  advanced Excel
                </li>
                <li>
                  <strong>Tools & Platforms:</strong> Git/GitHub, Web APIs,
                  Command Line, basic CI
                </li>
                <li>
                  <strong>Development Practices:</strong> Requirements
                  gathering, prototyping, A/B testing, metrics wiring
                </li>
              </ul>
            </div>
            ...
            {/* Business & Analytical Strengths */}
            <div className="section">
              <h2>Business & Analytical Strengths</h2>
              <ul>
                <li>
                  <strong>Structured Analysis:</strong> Trend identification,
                  data interpretation, logic-based conclusions
                </li>
                <li>
                  <strong>Operational Focus:</strong> Workflow design,
                  documentation, process automation
                </li>
                <li>
                  <strong>Market Insight:</strong> Positioning analysis,
                  customer segmentation, campaign evaluation
                </li>
                <li>
                  <strong>Communication:</strong> Clear technical writing;
                  translation of insights for business stakeholders
                </li>
              </ul>
            </div>
            ...
            <div className="section">
              ...
              <ul>
                <li>
                  Full-Stack Web Development Bootcamp — UNC Chapel Hill
                  (2022–2023)
                </li>
              </ul>
            </div>
            ...
            <div className="section">
              ...
              <ul>
                <li>Phi Kappa Phi Honor Society — Active Member</li>
              </ul>
            </div>
            ...
            <div className="section">
              ...
              <ul>
                <li>
                  Dual 4.0 GPA in both liberal arts and business disciplines
                </li>
                <li>
                  Delivered real-world strategy for a global client through
                  international collaboration
                </li>
                <li>
                  Operating two ventures while maintaining technical fluency
                </li>
              </ul>
            </div>
