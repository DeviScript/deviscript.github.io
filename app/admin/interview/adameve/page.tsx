      ...
      <div className="mx-auto max-w-7xl p-6 pt-24">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-4">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h1 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600 bg-clip-text text-transparent mb-2 leading-tight">
                  Digital Merchandising Resources
                </h1>
                ...
                <p className="text-base text-gray-600 dark:text-gray-400 max-w-2xl">
                  Comprehensive merchandising framework: search optimization
                  playbook, KPI analysis, A/B testing methodology, product
                  intelligence, and compliance strategies
                </p>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row lg:flex-col items-start sm:items-center lg:items-end gap-3">
              ...
              <StatusBadge status="Resource Library" variant="success" />
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-3 leading-relaxed">
                This resource library demonstrates expertise in digital
                merchandising strategy and ecommerce optimization. All
                frameworks, methodologies, and best practices are based on
                <strong>
                  {" "}
                  industry standards and professional experience
                </strong>{" "}
                including search optimization techniques, KPI frameworks, A/B
                testing methodologies, and product intelligence systems. These
                resources showcase strategic thinking and practical
                implementation approaches for ecommerce merchandising roles.
              </p>
        ...
        <section className="mb-8 bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700">
          ...
          <div className="mb-6 p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Modern ecommerce merchandising requires a strategic blend of{" "}
              <strong>data analytics</strong>,{" "}
              <strong>search optimization</strong>,{" "}
              <strong>product intelligence</strong>, and{" "}
              <strong>customer experience design</strong>. These resources
              demonstrate proven frameworks for driving conversion, optimizing
              product discovery, and maximizing revenue through intelligent
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                <li className="flex items-center gap-3">
                  ...
                  <span>Search platform governance & optimization</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-blue-500 rounded-full flex-shrink-0" />
                  <span>Product ranking & recommendation strategies</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-green-500 rounded-full flex-shrink-0" />
                  <span>KPI-driven performance optimization</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-amber-500 rounded-full flex-shrink-0" />
                  <span>A/B testing & experimentation frameworks</span>
                </li>
              </ul>
            </div>

            {/* Middle Column - Strategic Focus */}
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-3">
              ...
              <ul className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                <li className="flex items-center gap-3">
                  ...
                  <span>
                    <strong>Conversion Rate</strong> optimization
                  </span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-blue-500 rounded-full flex-shrink-0" />
                  <span>
                    <strong>AOV & RPV</strong> growth strategies
                  </span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-purple-500 rounded-full flex-shrink-0" />
                  <span>
                    <strong>Product Discovery</strong> enhancement
                  </span>
                </li>
                <li className="flex items-center gap-3">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-green-500 rounded-full flex-shrink-0" />
                  <span>Search platform implementation (HawkSearch, etc.)</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-blue-500 rounded-full flex-shrink-0" />
                  <span>Analytics & data-driven decision making</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-purple-500 rounded-full flex-shrink-0" />
                  <span>Merchandising rule engines & algorithms</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-amber-500 rounded-full flex-shrink-0" />
                  <span>Cross-functional collaboration & leadership</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg border border-green-200 dark:border-green-800">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              These resources emphasize <strong>actionable strategies</strong>{" "}
              and <strong>proven methodologies</strong> for merchandising
              managers. Each section includes real-world applications, KPI
              frameworks, testing approaches, and compliance considerations
              adaptable to various ecommerce environments and business models.
            </p>
          </div>
        </section>
          ...
          <div className="bg-gradient-to-r from-indigo-50 via-blue-50 to-purple-50 dark:from-indigo-900/20 dark:via-blue-900/20 dark:to-purple-900/20 rounded-xl p-8 border border-indigo-200 dark:border-indigo-800 shadow-lg">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                  🎯 Professional Q&A Framework
                </h2>
                <p className="text-gray-600 dark:text-gray-400 text-lg">
                  Comprehensive assessment examples covering experience,
                  strategic approach, problem-solving methodologies, and
            ...
            >
              <span className="font-medium">
                View Q&A Preparation Framework
              </span>
        ...
        <section className="mb-8 bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
            ...
            Merchandising Resources & Frameworks
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="text-left flex-1">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  Ranking strategies, governance, KPI optimization
                </div>
              </div>
            ...
            >
              ...
              <div className="text-left flex-1">
                <div className="font-medium text-gray-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400">
                  Search Optimization Database
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  Synonyms, redirects & category mapping
                </div>
              </div>
            ...
            >
              ...
              <div className="text-left flex-1">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  Catalog analysis, pricing strategy, brand tiers
                </div>
              </div>
